...
snakemake <- Snakemake(
    input = list('../wham/TVU12-6325_S41_L004/TVU12-6325_S41_L004-wham_ordered.csv', '../novobreak/TVU12-6325_S41_L004/TVU12-6325_S41_L004-novobreak_ordered.csv', '../gridss/TVU12-6325_S41_L004/TVU12-6325_S41_L004-gridss_ordered.csv', '../breakmer/TVU12-6325_S41_L004/TVU12-6325_S41_L004-breakmer_ordered.csv', "wham" = '../wham/TVU12-6325_S41_L004/TVU12-6325_S41_L004-wham_ordered.csv', "novobreak" = '../novobreak/TVU12-6325_S41_L004/TVU12-6325_S41_L004-novobreak_ordered.csv', "gridss" = '../gridss/TVU12-6325_S41_L004/TVU12-6325_S41_L004-gridss_ordered.csv', "breakmer" = '../breakmer/TVU12-6325_S41_L004/TVU12-6325_S41_L004-breakmer_ordered.csv'),
    output = list('../merged/TVU12-6325_S41_L004-other_merged.csv', '../merged/TVU12-6325_S41_L004-trl_merged.csv', '../merged/TVU12-6325_S41_L004-IG_merged.csv', '../merged/TVU12-6325_S41_L004-trl_summary.csv', "IG" = '../merged/TVU12-6325_S41_L004-IG_merged.csv', "trl" = '../merged/TVU12-6325_S41_L004-trl_merged.csv', "otherSVs" = '../merged/TVU12-6325_S41_L004-other_merged.csv', "summary" = '../merged/TVU12-6325_S41_L004-trl_summary.csv'),
    params = list(),
