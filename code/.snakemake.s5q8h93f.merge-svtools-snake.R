...
snakemake <- Snakemake(
    ...
    output = list('../merged/TVU12-6325_S41_L004-other_merged.csv', '../merged/TVU12-6325_S41_L004-IG_merged.csv', '../merged/TVU12-6325_S41_L004-trl_summary.csv', '../merged/TVU12-6325_S41_L004-trl_merged.csv', "otherSVs" = '../merged/TVU12-6325_S41_L004-other_merged.csv', "IG" = '../merged/TVU12-6325_S41_L004-IG_merged.csv', "summary" = '../merged/TVU12-6325_S41_L004-trl_summary.csv', "trl" = '../merged/TVU12-6325_S41_L004-trl_merged.csv'),
    params = list(),
    wildcards = list('TVU12-6325_S41_L004', "sample" = 'TVU12-6325_S41_L004'),
    threads = 1,
    log = list(),
    resources = list(),
    config = list("wham" = list("CLASSIFY" = '/net/nfs/PAT/home/tjitske/WHAM/wham/utils/classify_WHAM_vcf.py', "TRAIN" = '/net/nfs/PAT/home/tjitske/WHAM/wham/data/WHAM_training_data.txt', "MAPQUAL" = 10, "BASEQUAL" = 5, "WHAM" = '/net/nfs/PAT/home/tjitske/WHAM/wham/bin/wham'), "novobreak" = list("NOVOBREAK" = '/net/nfs/PAT/home/tjitske/novobreak/nb_distribution/run_novoBreak.sh', "HEADER" = '/net/nfs/PAT/home/tjitske/novobreak/nb_distribution/header.txt', "NORMAL" = '/net/nfs/PAT/analysis/MPS-310/Blood_combined_bam/combined_healthy_blood_nochr.bam', "EXE_DIR" = '/net/nfs/PAT/home/tjitske/novobreak/nb_distribution'), "all" = list("THREADS" = 4, "targets" = 'code/BCNHLv2_primary_coord.bed', "Annotationfile" = 'code/annotation_new_BCNHL-v2.bed', "REF_CHR" = '/net/nfs/PAT/home/tjitske/files/ref/incl_chr/hg19.fa', "REF_NOCHR" = '/net/nfs/PAT/home/tjitske/files/ref/excl_chr/hg19_refgen_exclchr.fa'), "filters" = list("splitread" = 4, "highSVevidence" = 15, "blacklist" = 'code/blacklist.bed', "discread" = 3, "novoscore" = 4, "gridssscore" = 450), "gridss" = list("GRIDSS_JAR" = '/net/nfs/PAT/home/tjitske/GRIDSS/gridss-1.4.2-jar-with-dependencies.jar')),
    rule = 'merge_svtools'
)
######## Original script #########
#!/usr/bin/env Rscript
