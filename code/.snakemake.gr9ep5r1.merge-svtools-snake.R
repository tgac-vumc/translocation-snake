...
snakemake <- Snakemake(
    input = list('../wham/TVU12-6325_S41_L004/TVU12-6325_S41_L004-wham_ordered.csv', '../gridss/TVU12-6325_S41_L004/TVU12-6325_S41_L004-gridss_ordered.csv', '../novobreak/TVU12-6325_S41_L004/TVU12-6325_S41_L004-novobreak_ordered.csv', '../breakmer/TVU12-6325_S41_L004/TVU12-6325_S41_L004-breakmer_ordered.csv', "wham" = '../wham/TVU12-6325_S41_L004/TVU12-6325_S41_L004-wham_ordered.csv', "gridss" = '../gridss/TVU12-6325_S41_L004/TVU12-6325_S41_L004-gridss_ordered.csv', "novobreak" = '../novobreak/TVU12-6325_S41_L004/TVU12-6325_S41_L004-novobreak_ordered.csv', "breakmer" = '../breakmer/TVU12-6325_S41_L004/TVU12-6325_S41_L004-breakmer_ordered.csv'),
    output = list('../merged/TVU12-6325_S41_L004-IG_merged.csv', '../merged/TVU12-6325_S41_L004-other_merged.csv', '../merged/TVU12-6325_S41_L004-trl_merged.csv', '../merged/TVU12-6325_S41_L004-trl_summary.csv', "IG" = '../merged/TVU12-6325_S41_L004-IG_merged.csv', "otherSVs" = '../merged/TVU12-6325_S41_L004-other_merged.csv', "trl" = '../merged/TVU12-6325_S41_L004-trl_merged.csv', "summary" = '../merged/TVU12-6325_S41_L004-trl_summary.csv'),
    params = list(),
    wildcards = list('TVU12-6325_S41_L004', "sample" = 'TVU12-6325_S41_L004'),
    threads = 1,
    log = list(),
    resources = list(),
    config = list("wham" = list("BASEQUAL" = 5, "TRAIN" = '/net/nfs/PAT/home/tjitske/WHAM/wham/data/WHAM_training_data.txt', "MAPQUAL" = 10, "CLASSIFY" = '/net/nfs/PAT/home/tjitske/WHAM/wham/utils/classify_WHAM_vcf.py', "WHAM" = '/net/nfs/PAT/home/tjitske/WHAM/wham/bin/wham'), "gridss" = list("GRIDSS_JAR" = '/net/nfs/PAT/home/tjitske/GRIDSS/gridss-1.4.2-jar-with-dependencies.jar'), "all" = list("Annotationfile" = 'code/annotation_new_BCNHL-v2.bed', "targets" = 'code/BCNHLv2_primary_coord.bed', "REF_CHR" = '/net/nfs/PAT/home/tjitske/files/ref/incl_chr/hg19.fa', "REF_NOCHR" = '/net/nfs/PAT/home/tjitske/files/ref/excl_chr/hg19_refgen_exclchr.fa', "THREADS" = 4), "novobreak" = list("HEADER" = '/net/nfs/PAT/home/tjitske/novobreak/nb_distribution/header.txt', "EXE_DIR" = '/net/nfs/PAT/home/tjitske/novobreak/nb_distribution', "NORMAL" = '/net/nfs/PAT/analysis/MPS-310/Blood_combined_bam/combined_healthy_blood_nochr.bam', "NOVOBREAK" = '/net/nfs/PAT/home/tjitske/novobreak/nb_distribution/run_novoBreak.sh'), "filters" = list("highSVevidence" = 15, "splitread" = 4, "gridssscore" = 450, "discread" = 3, "novoscore" = 4, "blacklist" = 'code/blacklist.bed')),
    rule = 'merge_svtools'
)
######## Original script #########
#!/usr/bin/env Rscript
